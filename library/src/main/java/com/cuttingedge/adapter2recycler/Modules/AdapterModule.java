...
public abstract class AdapterModule<VH extends ViewHolder, I extends ModularItem> {
	 ...
	 *
	 * @param adapter
	 * 		ModularAdapter for which this module is meant to be used.
	 */
	 ...
	 *
	 * @param viewHolder
	 * 		The ViewHolder which should be updated to represent the contents of the item.
	 * @param item
	 * 		item to get contents from.
	 */
	 ...
	 */
	protected Class<I> returnedClass() {
		Class c = getClass();
